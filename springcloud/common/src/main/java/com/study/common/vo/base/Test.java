...
public class Test {
    ...
    public ShowapiResBodyWechatVo getShowapi_res_body() {
        return showapi_res_body;
    }

    public void setShowapi_res_body(ShowapiResBodyWechatVo showapi_res_body) {
